...
deepspeed llava/train/train_mem.py \
    ...
    --ecg_folder /home/work/hallucination/ecg/ECG-Chat/physionet.org/files/mimic-iv-ecg/1.0 \
    --ecg_tower /home/work/hallucination/ecg/Origin/open_clip/logs/epoch_10.pt \
